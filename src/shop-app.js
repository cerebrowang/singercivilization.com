...
import 'polymerfire3/firebase-app-script.js';
import 'polymerfire3/firebase-auth-script.js';
import 'polymerfire3/firebase-database-script.js';
import 'polymerfire3/firebase-storage-script.js';
import 'polymerfire3/firebase-app.js';

let config = {
  apiKey: "AIzaSyCp9R59uDsOiGNTXfL_TGUjQIX-3QrEDFA",
  authDomain: "singercivilization-id.firebaseapp.com",
  databaseURL: "https://singercivilization-id.firebaseio.com",
  projectId: "singercivilization-id",
  storageBucket: "singercivilization-id.appspot.com",
  messagingSenderId: "799812786540"
};
  ...
  static get template() {
    ...
    <app-header role="navigation" id="header" effects="waterfall" condenses="" reveals="">
      <app-toolbar>
        ...
        <div class="logo" main-title=""><iron-icon src="images/shop-icon-32.png"></iron-icon><a href="/" aria-label="SHOP Home">inger Civilization</a></div>
